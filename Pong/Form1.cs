...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        private void SetParameters()
        {
            ...
            ball.Y = this.Width / 2 - ball.Width / 2;
        ...
        private void gameUpdateLoop_Tick(object sender, EventArgs e)
        {
            ...
            if (ballMoveDown == true && ball.Y < this.Height - ball.Width)
            {
                ball.Y += BALL_SPEED;
            }
            else
        ...
        private void GameOver(string winner)
        {
            ...
            p1.Y = this.Height / 2 - 20;
            p2.Y = this.Height / 2 - 20;
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString("" + player1Score, drawFont, drawBrush, 15, 40);
            e.Graphics.DrawString("" + player2Score, drawFont, drawBrush, this.Width - 30, 40);
        }
